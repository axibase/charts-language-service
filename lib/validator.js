(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver-types", "./config", "./configTree/configTree", "./configTree/configTreeValidator", "./defaultSetting", "./keywordHandler", "./languageService", "./messageUtil", "./regExpressions", "./sectionStack", "./setting", "./textRange", "./util", "./resourcesProviderBase"], factory);
    }
