...
\${0}`;
    ...
    completeSectionName() {
        const items = [];
        const sectionNames = Object.keys(resourcesProviderBase_1.ResourcesProviderBase.sectionDepthMap);
    ...
    completeSnippets() {
        const items = Object.keys(exports.snippets).map((key) => {
            const insertText = (typeof exports.snippets[key].body === "string") ?
                exports.snippets[key].body : exports.snippets[key].body.join("\n");
